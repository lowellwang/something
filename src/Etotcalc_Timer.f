...
c 09162015, add timer
      real*8 time_start,time_end
       ...
       if(inode.eq.1) then
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| Etotcalc.f timer start"
...
ccccccccccccccccccccccccccccccccccccc
        ...
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| getewald,",time_end-time_start
        time_start=mpi_wtime()
        endif
ccccccccccccccccccccccccccccccccccccc
...
ccccccccccccccccccccccccccccccccccccc
        ...
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| getVrhoL,",time_end-time_start
        time_start=mpi_wtime()
        endif
ccccccccccccccccccccccccccccccccccccc
...
ccccccccccccccccccccccccccccccccccccc
        ...
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| before CG_function,",time_end-time_start
        time_start=mpi_wtime()
        endif
ccccccccccccccccccccccccccccccccccccc
...
ccccccccccccccccccccccccccccccccccccc
        ...
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| CG_function,",time_end-time_start
        time_start=mpi_wtime()
        endif
ccccccccccccccccccccccccccccccccccccc
...
ccccccccccccccccccccccccccccccccccccc
        ...
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| Return,",time_end-time_start
        time_start=mpi_wtime()
        endif
ccccccccccccccccccccccccccccccccccccc
