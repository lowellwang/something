...
c 09162015, add timer
      real*8 time_start,time_end

       if(inode.eq.1) then
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| CG_Allband timer start"
...
ccccccccccccccccccccccccccccccccccccc
        ...
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| Before Hpsi,",time_end-time_start
        time_start=mpi_wtime()
        endif
ccccccccccccccccccccccccccccccccccccc
...
ccccccccccccccccccccccccccccccccccccc
        ...
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| Hpsi,",time_end-time_start
        time_start=mpi_wtime()
        endif
ccccccccccccccccccccccccccccccccccccc
...
ccccccccccccccccccccccccccccccccccccc
        ...
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| dot_product_BP,",time_end-time_start
        time_start=mpi_wtime()
        endif
ccccccccccccccccccccccccccccccccccccc
...
ccccccccccccccccccccccccccccccccccccc
        ...
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| czheev,",time_end-time_start
        time_start=mpi_wtime()
        endif
ccccccccccccccccccccccccccccccccccccc
...
ccccccccccccccccccccccccccccccccccccc
        ...
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| rotate,",time_end-time_start
        time_start=mpi_wtime()
        endif
ccccccccccccccccccccccccccccccccccccc
...
ccccccccccccccccccccccccccccccccccccc
        ...
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| Before allreduce,",time_end-time_start
        time_start=mpi_wtime()
        endif
ccccccccccccccccccccccccccccccccccccc
...
ccccccccccccccccccccccccccccccccccccc
        ...
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| allreduce 1,",time_end-time_start
        time_start=mpi_wtime()
        endif
ccccccccccccccccccccccccccccccccccccc
...
ccccccccccccccccccccccccccccccccccccc
        ...
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| test 01,",time_end-time_start
        time_start=mpi_wtime()
        endif
ccccccccccccccccccccccccccccccccccccc
...
ccccccccccccccccccccccccccccccccccccc
        ...
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| allreduce 2,",time_end-time_start
        time_start=mpi_wtime()
        endif
ccccccccccccccccccccccccccccccccccccc
...
ccccccccccccccccccccccccccccccccccccc
        ...
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| test 02,",time_end-time_start
        time_start=mpi_wtime()
        endif
ccccccccccccccccccccccccccccccccccccc
...
ccccccccccccccccccccccccccccccccccccc
        ...
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| allreduce 3,",time_end-time_start
        time_start=mpi_wtime()
        endif
ccccccccccccccccccccccccccccccccccccc
...
ccccccccccccccccccccccccccccccccccccc
        ...
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| test 03,",time_end-time_start
        time_start=mpi_wtime()
        endif
ccccccccccccccccccccccccccccccccccccc
...
ccccccccccccccccccccccccccccccccccccc
        ...
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| allreduce 4,",time_end-time_start
        time_start=mpi_wtime()
        endif
ccccccccccccccccccccccccccccccccccccc
...
ccccccccccccccccccccccccccccccccccccc
        ...
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| test 04,",time_end-time_start
        time_start=mpi_wtime()
        endif
ccccccccccccccccccccccccccccccccccccc
...
ccccccccccccccccccccccccccccccccccccc
        ...
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| allreduce 5,",time_end-time_start
        time_start=mpi_wtime()
        endif
ccccccccccccccccccccccccccccccccccccc
**********************************************
...
ccccccccccccccccccccccccccccccccccccc
        ...
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| test 05,",time_end-time_start
        time_start=mpi_wtime()
        endif
ccccccccccccccccccccccccccccccccccccc
...
ccccccccccccccccccccccccccccccccccccc
        ...
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| orthogonal,",time_end-time_start
        time_start=mpi_wtime()
        endif
ccccccccccccccccccccccccccccccccccccc
...
ccccccccccccccccccccccccccccccccccccc
        ...
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| Hpsi_comp_AllbandBP,",time_end-time_start
        time_start=mpi_wtime()
        endif
ccccccccccccccccccccccccccccccccccccc
...
ccccccccccccccccccccccccccccccccccccc
        ...
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| test 06,",time_end-time_start
        time_start=mpi_wtime()
        endif
ccccccccccccccccccccccccccccccccccccc
...
ccccccccccccccccccccccccccccccccccccc
        ...
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| allreduce 6,",time_end-time_start
        time_start=mpi_wtime()
        endif
ccccccccccccccccccccccccccccccccccccc
...
ccccccccccccccccccccccccccccccccccccc
        ...
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| test 07,",time_end-time_start
        time_start=mpi_wtime()
        endif
ccccccccccccccccccccccccccccccccccccc
...
ccccccccccccccccccccccccccccccccccccc
        ...
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| allreduce 7,",time_end-time_start
        time_start=mpi_wtime()
        endif
ccccccccccccccccccccccccccccccccccccc
...
ccccccccccccccccccccccccccccccccccccc
        ...
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| test 08,",time_end-time_start
        time_start=mpi_wtime()
        endif
ccccccccccccccccccccccccccccccccccccc
...
ccccccccccccccccccccccccccccccccccccc
        ...
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| allreduce 8,",time_end-time_start
        time_start=mpi_wtime()
        endif
ccccccccccccccccccccccccccccccccccccc
**********************************************
...
ccccccccccccccccccccccccccccccccccccc
        ...
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| test 09,",time_end-time_start
        time_start=mpi_wtime()
        endif
ccccccccccccccccccccccccccccccccccccc
...
3001  continue
      ...
      if(inode_tot.eq.1) write(6,*) 'NLINE=',nint2
...
ccccccccccccccccccccccccccccccccccccc
        ...
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| test 10,",time_end-time_start
        time_start=mpi_wtime()
        endif
ccccccccccccccccccccccccccccccccccccc
...
ccccccccccccccccccccccccccccccccccccc
        ...
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| test 11,",time_end-time_start
        time_start=mpi_wtime()
        endif
ccccccccccccccccccccccccccccccccccccc
...
ccccccccccccccccccccccccccccccccccccc
        ...
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| test 12,",time_end-time_start
        time_start=mpi_wtime()
        endif
ccccccccccccccccccccccccccccccccccccc
***********************************************
