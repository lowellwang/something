       subroutine Hpsi_comp_tmp(wg,wgh,ilocal,vr,workr_n,kpt,
     &  isij,swg,sumdum,iislda,ave_X,dX)
...
cccccccccccccccccccccccccccccccccccccccccc
       ...
       x=(i1-1)*1.d0/n1
       ave_X=ave_X+abs(workr_n(i))**2*x
       sum=sum+abs(workr_n(i))**2
       enddo

       call global_sumr(sum)
       call global_sumr(ave_X)
       ave_X=ave_X/sum
       ...
       k1=jj-(i1-1)*n2*n3-(j1-1)*n3
       x=(i1-1)*1.d0/n1
       dX=dX+abs(workr_n(i))**2*(x-ave_X)**2
       enddo
