...
c 09162015, add timer
      real*8 time_start,time_end
       ...
       if(inode.eq.1) then
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| Hpsi_comp_AB timer start"
...
ccccccccccccccccccccccccccccccccccccc
        ...
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| test 01.5,",time_end-time_start
        time_start=mpi_wtime()
        endif
ccccccccccccccccccccccccccccccccccccc
...
ccccccccccccccccccccccccccccccccccccc
        ...
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| testin 01,",time_end-time_start
        time_start=mpi_wtime()
        endif
ccccccccccccccccccccccccccccccccccccc
...
ccccccccccccccccccccccccccccccccccccc
        ...
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| testin 02,",time_end-time_start
        time_start=mpi_wtime()
        endif
ccccccccccccccccccccccccccccccccccccc
...
ccccccccccccccccccccccccccccccccccccc
        ...
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| testin 03,",time_end-time_start
        time_start=mpi_wtime()
        endif
ccccccccccccccccccccccccccccccccccccc
...
ccccccccccccccccccccccccccccccccccccc
        ...
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| testin 04,",time_end-time_start
        time_start=mpi_wtime()
        endif
ccccccccccccccccccccccccccccccccccccc
...
ccccccccccccccccccccccccccccccccccccc
        ...
        write(6,*)
        write(6,*) "------------------------------"
        write(6,*) "| testin 05,",time_end-time_start
        time_start=mpi_wtime()
        endif
ccccccccccccccccccccccccccccccccccccc
